...
public class DomainHelper 
{
    ...
    protected static final String AGENT_HAS_KNOWLEDGE_ABOUT = "agentHasKnowledgeAbout";
    ...
    {
        return addRelationSignature(name, 1);
    }
    ...
    public void addObject(String o)
    {
        ...
        object.setContent(o);
        object.setType(DomainHelper.OBJECT_TYPE);
